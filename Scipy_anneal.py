...
import numpy
from numpy import asarray, tan, exp, ones, squeeze, sign,      all, log, sqrt, pi, shape, array, minimum, where, random
from optimize1 import Result, _check_unknown_options
...
def anneal(func, x0, args=(), schedule='fast', full_output=0,
    ...
    over loop over range(dwell), and new points are generated for
    ...
    if full_output:
        return res['x'], res['fun'], res['T'], res['nfev'], res['nit'],             res['accept'], res['status']
    else:
